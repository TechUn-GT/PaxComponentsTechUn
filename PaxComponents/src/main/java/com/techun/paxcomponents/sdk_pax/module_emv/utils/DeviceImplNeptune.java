...
import static com.techun.paxcomponents.sdk_pax.module_emv.utils.MiscUtils.bcd2Str;
...
public class DeviceImplNeptune implements IDevice {
    ...
    private int iccIsoCommandDevice(final ApduSendL2 apduSend, ApduRespL2 apduRecv) {
        ...
        //logs sugeridos por PAX Caso 46, Respuesta del 2021-08-16 07:12:35
        Log.i("DeviceImpl", "--------------------INICIO CASO TEST-----------------------");
        ...
        Log.i("DeviceImpl", "--------------------FIN CASO TEST-----------------------");
    ...
    private int piccIsoCommandDevice(ApduSendL2 apduSend, ApduRespL2 apduRecv) {
        ...
        Util.INSTANCE.logsUtils("piccIsoCommandDevice - apduSend = " + bcd2Str(apduSend.command), 0);
        Util.INSTANCE.logsUtils("piccIsoCommandDevice - Data = " + bcd2Str(apduSend.dataIn), 0);
        ...
        try {
            ...
            apduRecv.swa = resp.getSwA();
            apduRecv.swb = resp.getSwB();
            Util.INSTANCE.logsUtils("piccIsoCommandDevice - swa = " + bcd2Str(new byte[]{apduRecv.swa}), 0);
            Util.INSTANCE.logsUtils("piccIsoCommandDevice - swb = " + bcd2Str(new byte[]{apduRecv.swb}), 0);
            return DeviceRetCode.DEVICE_PICC_OK;
    ...
    public int pedVerifyCipherPin(RsaPinKeyL2 rsaPinKeyIn, byte[] iccRespOut, byte mode) {
        Util.INSTANCE.logsUtils("pedVerifyCipherPin:" + mode, 0);
