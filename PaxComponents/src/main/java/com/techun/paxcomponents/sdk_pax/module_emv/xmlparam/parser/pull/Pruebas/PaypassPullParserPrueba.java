package com.techun.paxcomponents.sdk_pax.module_emv.xmlparam.parser.pull.Pruebas;
...
public class PaypassPullParserPrueba {
    public void parse(Context mContext) {
        try (InputStream inputStream = mContext.getAssets().open("paypass_param.clss_mc")) {
